...
1. Добавете е2е тестове към `registration.cy.js`, в които тествате останалите полето на формата регистрация. Във всеки тест трябва да въведете невалидна стойност в полета и да видите дали се появило съобщение за грешка.
