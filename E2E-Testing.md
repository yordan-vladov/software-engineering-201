...
1. Добавете е2е тестове към `registration.cy.js`, в които тествате останалите полетa на формата регистрация. Във всеки тест трябва да въведете невалидна стойност в полетo и да видите дали се появило съобщение за грешка.
